...
function initChart() {
  ...
  chart = LightweightCharts.createChart(chartEl, {
    layout: {
      background: { color: '#0e1217' },    // literal
      textColor:   '#D1D5DB'
    },
    grid: {
...
function showBanner(txt, good = true) {
  ...
  bannerEl.style.background = good ? '#22c55e' : '#ef4444'; // cores literais
